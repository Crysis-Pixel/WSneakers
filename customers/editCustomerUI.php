...
<head>
  ...
  <link rel="stylesheet" href="../adminPage/editCustomer.css">
</head>
<?php
...
?>
<body class="body">
  <form action="./editCustomerPage.php" method="post">
    <div class="username">
    ...
    <div>
      <input class="editBtn" type="submit" name="editCustomer" value="Edit">
    </div>
  </form>
</body>
